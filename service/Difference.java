...
public class Difference implements ExampleImpl {
    ...
    public void exampl(FirstNamber firstNamber, SecondNumber secondNumber) {
        ...
        logger.info("Начал считать вычитание");
        String markFirst;
        String markSecond;
        ...
        if ((firstNamber.getNamberY() + secondNumber.getNamberY()) >= 0) {
            ...
            System.out.println("(" + firstNamber.getNamberX() +
                    ...
                    "+" +
                    (firstNamber.getNamberY() + secondNumber.getNamberY()) + "i" + ")");
        } else {
            System.out.println("(" + firstNamber.getNamberX() +
                    markFirst +
                    firstNamber.getNamberY() + "i" + ")" +
